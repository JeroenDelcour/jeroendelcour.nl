var infiniteScrolling = {
	...
	scrollFunction: function(){
		if (!infiniteScrolling.blocked){
			...
			var margin = 50;
			if (document.documentElement.scrollTop>= document.body.scrollHeight - window.innerHeight - margin || document.body.scrollTop >= document.body.scrollHeight - window.innerHeight - margin) {
